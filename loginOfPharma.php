...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="loginOfPharma.php"><b><img src="pharmatrain.png" alt=""></b></a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="loginOfPharma.php">CoursesList</a></li>
        <li><a href="loginOfPharma.php">BuyCourses</a></li>
        <li><a href="loginOfPharma.php">CourseSales</a></li>
        <li>
          ...
          <ul class="dropdown-menu">
            <li><a href="loginOfPharma.php">AddCourses</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="loginOfPharma.php">AddCoursetype</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
...
<p>Not registered yet? <a href='registerOfPharma.php'>Register Here</a></p>
</div>
-->
